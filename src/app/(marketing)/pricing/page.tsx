  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-16 md:px-8 md:py-24">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-slate-600">One plan with everything. Try it free for {TRIAL_DAYS} days, no credit card.</p>
      </div>

      <div className="mx-auto mt-12 max-w-md rounded-2xl border border-slate-200 p-8 shadow-sm">
        <h2 className="text-lg font-semibold text-slate-900">Pro</h2>
        <p className="mt-4 flex items-baseline gap-1">
          <span className="text-5xl font-bold tracking-tight text-slate-900">${PRICE_MONTHLY_USD}</span>
          <span className="text-slate-500">/ month</span>
        </p>
        <p className="mt-2 text-sm text-slate-500">Billed monthly. Sales tax added where applicable. Cancel anytime.</p>
      ...
      <div className="mx-auto mt-16 max-w-2xl space-y-6 text-slate-700">
        <div>
          <h3 className="font-semibold text-slate-900">What happens when the trial ends?</h3>
          <p className="mt-1">Your data stays safe. Subscribe to keep preparing statements; nothing is charged until you do.</p>
        </div>
        <div>
          <h3 className="font-semibold text-slate-900">How do I cancel?</h3>
          <p className="mt-1">From the billing page, in two clicks. You keep access until the end of the month you paid for.</p>
        </div>
        <div>
          <h3 className="font-semibold text-slate-900">Who processes payments?</h3>
          <p className="mt-1">Lemon Squeezy, our merchant of record, handles payment, sales tax and invoices.</p>
        </div>
        <div>
          <h3 className="font-semibold text-slate-900">Managing many properties?</h3>
          <p className="mt-1">
