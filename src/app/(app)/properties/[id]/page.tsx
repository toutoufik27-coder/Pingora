...
import { deletePropertyAction } from "@/server/actions/transactions";
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <form action={deletePropertyAction.bind(null, property.id)}>
            <ConfirmButton
              ...
              confirmMessage={`Delete ${property.name} and its ${property.transactionCount} transactions? Statements will change.`}
            />
          </form>
        </div>
      </Card>
