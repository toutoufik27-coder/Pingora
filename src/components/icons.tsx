...
const PATHS: Record<IconName, string[]> = {
  ...
  users: ["M9 11a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z", "M3 20c0-3.3 2.7-5.5 6-5.5s6 2.2 6 5.5", "M16 4.5a3.5 3.5 0 0 1 0 6.5", "M18 14.8c1.8.7 3 2.5 3 5.2"],
...
export function Icon({ name, className = "size-5", ...props }: { name: IconName } & SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75} strokeLinecap="round" strokeLinejoin="round" aria-hidden className={className} {...props}>
      {PATHS[name].map((d) => (
        <path key={d} d={d} />
      ))}
    </svg>
